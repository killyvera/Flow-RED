...
module.exports = {
     ...
     * lost.
     * 
     * IMPORTANTE: Si ya tienes credenciales guardadas, NO cambies este valor
     * o perderás acceso a las credenciales existentes.
     */
    // Si no hay credentialSecret configurado, Node-RED generará uno automáticamente
    // Para producción, es recomendable configurar uno explícito:
    // credentialSecret: process.env.NODE_RED_CREDENTIAL_SECRET || "redflow-secret-key-change-in-production",
    ...
    */
    ...
    // ============================================
    persistentStorage: {
        // Enable the persistent storage plugin
        enabled: true,
        
        // Storage file name (relative to userDir)
        storageFile: 'redflow-persistent-storage.json',
        
        // Enable debug logging
        debug: process.env.PERSISTENT_STORAGE_DEBUG === 'true'
    },
    ...
    // ============================================
    // REDFLOW CUSTOM PLUGIN CONFIGURATIONS
    // ============================================
